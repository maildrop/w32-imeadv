...
#define WM_W32_IMEADV_OPENSTATUS_OPEN             (WM_W32_IMEADV_START + 2)
#define WM_W32_IMEADV_OPENSTATUS_CLOSE            (WM_W32_IMEADV_START + 3)
#define WM_W32_IMEADV_REQUEST_RECONVERSION_STRING (WM_W32_IMEADV_START + 4)
#define WM_W32_IMEADV_NOTIFY_RECONVERSION_STRING  (WM_W32_IMEADV_START + 5)
#define WM_W32_IMEADV_REQUEST_DOCUMENTFEED_STRING (WM_W32_IMEADV_START + 6)
#define WM_W32_IMEADV_NOTIFY_DOCUMENTFEED_STRING  (WM_W32_IMEADV_START + 7)
#define WM_W32_IMEADV_END                         (WM_W32_IMEADV_START + 8)
